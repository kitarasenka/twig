...
try {
  ...
  assert.deepEqual(await page.evaluate(() => Object.keys(window.twig).sort()), [
    ...
    'readConflict', 'readWorktree', 'rebaseOnto', 'resetTo', 'revertCommit', 'runSequencer', 'runSync',
    'saveConflict', 'saveGitProfileValue', 'selectRepository', 'stageFile', 'stashList', 'stashPop', 'stashPush', 'takeConflictSide',
    'trackFile', 'unstageFile', 'cancelClone', 'cancelRemote', 'changeRemote', 'chooseCloneDestination',
