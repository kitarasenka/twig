...
app.whenReady().then(async () => {
  ...
  const [, , automationPath] = await Promise.all([automations.load(), automationRuns.load(), resolveLoginPath(), editor.load(), fetchSettings.load()]);
  registerIpc(() => window, entryUrl, { journal, repositories, git, undo, marks, automations, automationRuns, automationPath, editor, fetchSettings });
  await createWindow();
